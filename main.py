...
for i in range(10):
    ...
    v_data_lbl = tk.Label(master=cell_frame, textvariable=vars[i], relief='sunken', width=4)
    i_data_lbl = tk.Label(master=cell_frame, textvariable=vars[i], relief='sunken', width=4)
